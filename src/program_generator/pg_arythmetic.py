...
class ProgramGenerator(object):
  ...
  def generate(self, fullCsv=False, count=1, gasLimit=None, opsLimit=None, bytecodeLimit=None, seed=None, dominant=None, push=32):
    """
    ...
    for i in range(count):
      program = self._generate_random_arithmetic(gasLimit, opsLimit, bytecodeLimit, dominant, push)
  ...
  def _generate_random_arithmetic(self, gasLimit, opsLimit, bytecodeLimit, dominant, push):
    """
