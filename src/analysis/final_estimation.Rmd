...
```{r fig.width=15, fig.height=10, include=FALSE}
if (FALSE) {
...
title(main="Relative cost")
legend(1, max_cost * 1.3, c(all_envs, "Current gas cost schedule"), fill=c(env_colors[1:length(all_envs)], 'grey'), cex=1)
}
```
