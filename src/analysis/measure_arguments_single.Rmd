...
ENV=`r params$env`. 
PROGRAMS=`r params$programs`. 
RESULTS=`r params$results`. 

Expected a result file `r paste(env, "_", program_set_codename, "_", measurement_codename, ".csv", sep="")`.  TODO
...
if(!marginal_estimated_cost_empty){
  ...
  print(all_estimated_cost_files)
...
```{r}
first_pass[which(first_pass$has_impacting), ]
```
