...
first_pass = data.frame(opcode=character(0), estimate_marginal_ns=numeric(0), estimate_marginal_ns_p=numeric(0),
...
for(i in 1:nrow(opcode_arity_df)) {
  ...
  first_pass[nrow(first_pass) + 1, ] = list(opcode, pure_op_count_coeff, pure_op_count_coeff_p, args_ns_raw[1], args_ns_raw[2], args_ns_raw[3], args_ns_p[1], args_ns_p[2], args_ns_p[3], expensive_ns_raw, expensive_ns_p)
}
