...
Parametrization. The env = `r env`, the programs file =`r params$programs`, the results file = `r params$results`, the details = `r details`.
...
```{r, incude = (params$output_estimated_cost != "")}
