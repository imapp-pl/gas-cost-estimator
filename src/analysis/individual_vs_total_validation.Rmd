...
plot_validation <- function(df, yvar, xvar) {
...
plot_validation(validation_problem_subset, explained_variable, estimate_variable)
```
...
```{r}
lm_validation(validation, explained_variable, 'current_gas_cost')
```
