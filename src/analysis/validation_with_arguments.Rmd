...
traces = read.csv(paste("../../local/trace_pg_", program_set_codename, ".csv", sep=""))
head(traces)
total_measurements_geth = read.csv(paste("../../local/geth_pg_", program_set_codename, "_", measurement_codename, ".csv", sep=""))
head(total_measurements_geth)
total_measurements_evmone = read.csv(paste("../../local/evmone_pg_", program_set_codename, "_", measurement_codename, ".csv", sep=""))
...
total_measurements_openethereum = read.csv(paste("../../local/openethereum_pg_", program_set_codename, "_", "16_400", ".csv", sep=""))
